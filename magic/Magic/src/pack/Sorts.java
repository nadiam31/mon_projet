...
public class Sorts extends Cartes {
	...
	public String toString(){
	 ...
	 static Sorts ID_11_1 = new Sorts("Pouvoir manavore", 2, "Bleu", "Double l'attaque et la vie d'une créature alliée, vous perdez 2 cristaux de mana");
	 static Sorts ID_12_1 = new Sorts("Dernier Tour", 10, "Bleu", "Détruit tout vos cristaux de mana, fixe les points de vie de l'adversaire à 10");
	 static Sorts ID_13_1 = new Sorts("Jackpot Magique", 7, "Bleu", "Vous gagnez 1 à 3 cristaux de mana vide");
	 static Sorts ID_14_1 = new Sorts("Accélération", 2, "Bleu", "Vous gagnez 1 cristal de mana vide");
	 static Sorts ID_15_1 = new Sorts("Magie Arcanique", 5, "Bleu", "Vous piochez une carte, elle coute 0 cristaux de mana");
	 static Sorts ID_16_1 = new Sorts("Carte à jeter", 4, "Rouge", "Vous piochez une carte, inflige son cout à l'adversaire et détruit la carte");
	 static Sorts ID_17_1 = new Sorts("Soin Magique", 4, "Blanc", "Vous piochez une carte, vous rends des points de vie équivant au cout de la carte");
	 static Sorts ID_18_1 = new Sorts("Eradication", 7, "Rouge", "Inflige 4 points de dégats à toutes les créatures adverses");
	 static Sorts ID_19_1 = new Sorts("Explosion Elementaire", 3, "Rouge", "Inflige 3 points de dégats, vous piochez une carte");
	 static Sorts ID_20_1 = new Sorts("Armement de masse", 5, "Vert", "Donne +1 de force à toutes vos créatures, ou qu'elles soient");
	 static Sorts ID_21_1 = new Sorts("Execution", 3, "Noir", "Détruit un serviteur blessé");
	 static Sorts ID_22_1 = new Sorts("Bouclier Arrière", 3, "Vert", "Confère *Ignore Recul* à une créature alliée");
	 static Sorts ID_23_1 = new Sorts("Tricherie", 6, "Bleu", "Détruit 3 cartes du deck adverse");
	 ...
	 static Sorts ID_11_2 = new Sorts("Pouvoir manavore", 2, "Bleu", "Double l'attaque et la vie d'une créature alliée, vous perdez 2 cristaux de mana");
	 static Sorts ID_12_2 = new Sorts("Dernier Tour", 10, "Bleu", "Détruit tout vos cristaux de mana, fixe les points de vie de l'adversaire à 10");
	 static Sorts ID_13_2 = new Sorts("Jackpot Magique", 7, "Bleu", "Vous gagnez 1 à 3 cristaux de mana vide");
	 static Sorts ID_14_2 = new Sorts("Accélération", 2, "Bleu", "Vous gagnez 1 cristal de mana vide");
	 static Sorts ID_15_2 = new Sorts("Magie Arcanique", 5, "Bleu", "Vous piochez une carte, elle coute 0 cristaux de mana");
	 static Sorts ID_16_2 = new Sorts("Carte à jeter", 4, "Rouge", "Vous piochez une carte, inflige son cout à l'adversaire et détruit la carte");
	 static Sorts ID_17_2 = new Sorts("Soin Magique", 4, "Blanc", "Vous piochez une carte, vous rends des points de vie équivant au cout de la carte");
	 static Sorts ID_18_2 = new Sorts("Eradication", 7, "Rouge", "Inflige 4 points de dégats à toutes les créatures adverses");
	 static Sorts ID_19_2 = new Sorts("Explosion Elementaire", 3, "Rouge", "Inflige 3 points de dégats, vous piochez une carte");
	 static Sorts ID_20_2= new Sorts("Armement de masse", 5, "Vert", "Donne +1 de force à toutes vos créatures, ou qu'elles soient");
	 static Sorts ID_21_2 = new Sorts("Execution", 3, "Noir", "Détruit un serviteur blessé");
	 static Sorts ID_22_2 = new Sorts("Bouclier Arrière", 3, "Vert", "Confère *Ignore Recul* à une créature alliée");
	 static Sorts ID_23_2 = new Sorts("Tricherie", 6, "Bleu", "Détruit 3 cartes du deck adverse");
