...
public class Ressources extends Cartes {
	...
	public String toString(){
	 ...
	 static Ressources ID_3_1 = new Ressources("Armurie", 4, "Force", 1, 4, "Au début de votre tour, donne +1 de force à tout les créatures alliées");
	 static Ressources ID_3_2 = new Ressources("Armurie", 3, "Force", 1, 4, "Au début de votre tour, donne +1 de force à tout les créatures alliées");
	 
	 static Ressources ID_4_1 = new Ressources("Hopital de fortune", 4, "Vitalité", 1, 3, "Au début de votre tour, donne +2 de vie à tout les créatures alliées");
	 static Ressources ID_4_2 = new Ressources("Hopital de fortune", 4, "Vitalité", 1, 3, "Au début de votre tour, donne +2 de vie à tout les créatures alliées");
	 
	 static Ressources ID_5_1 = new Ressources("Fabrique de cartes", 2, "Pioche", 1, 3, "Vous piochez une carte supplémentaire au début de votre tour");
	 static Ressources ID_5_2 = new Ressources("Fabrique de cartes", 2, "Pioche", 1, 3, "Vous piochez une carte supplémentaire au début de votre tour");
	 
	 static Ressources ID_6_1 = new Ressources("Cristal Magique", 5, "Cout", 1, 6, "Au début de votre tour, réduit le cout de vos cartes de 1 cristal de mana");
	 static Ressources ID_6_2 = new Ressources("Cristal Magique", 5, "Cout", 1, 6, "Au début de votre tour, réduit le cout de vos cartes de 1 cristal de mana");
	...
	public void Jouer(int cible){
		...
		int mn = Joueurs.J1.getMana() - ((Ressources) Joueurs.J1.getDeckJ1()[cible]).getCout(); //On soustrait le cout de la créature pour avoir le mana restant
		...
		int mn = Joueurs.J2.getMana() - ((Ressources) Joueurs.J2.getDeckJ2()[cible]).getCout(); //On soustrait le cout de la créature pour avoir le mana restant
	 ...
	 * 
	 * Méthode qui produit les ressources chaque tour (Exemple: 1 cristal de mana)
	 */
	 ...
	 * Créature qui meurt
	 * 
	 * Méthode qui tue les créatures si elles ont 0 points de vie
	 *
	 */
