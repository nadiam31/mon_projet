...
public class TestJoueurs {
	...
	public void testMeurt() {
		...
		assertFalse("Fail", Plateau.isEnJeu()); //Le plateau ne doit PAS être en jeu
		
		/**
		 * Si le joueur est vraiment mort, le plateau ne doit PAS être en jeu, donc le test DOIT marcher
		 * 
		 */
	}
	...
	public void testPioche(){
		...
		Joueurs.J1.setNombreCartes(0); //Zéro cartes dans la main
		...
		/**
		 * 
		 * Si le joueur a vraiment pioché une carte, le test DOIT fonctionner
		 * 
		 */
	...
	public void testPasse(){
		...
		/**
		 * 
		 * Si le joueur 1 a vraiment passé la main au joueur 2, le joueur 2 DOIT jouer, et le test DOIT fonctionner
		 */
	}
